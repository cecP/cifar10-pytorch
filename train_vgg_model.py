...
train_dataset = load_cifar10.CIFAR10Dataset(X_train[0:10000,:], y_train[0:10000], use_gpu=False, transform=transform) # in order for thransforms to work output tensors should not be on gpu
